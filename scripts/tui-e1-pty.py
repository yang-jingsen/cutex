...
child = subprocess.Popen([sys.argv[1], "ui_contract_e1_terminal_resize_detail_child", "--ignored", "--nocapture", "--test-threads=1"], stdin=slave, stdout=slave, stderr=slave, env=dict(os.environ, TERM="xterm-256color"), start_new_session=True)
output = b""
sent = set()
try:
    ...
    while time.monotonic() < deadline and child.poll() is None:
        ...
        for marker, key in [(b"E1_READY", b"\x1b[12~"), (b"E1_DETAILS", b""), (b"E1_RESIZED", b"\x1b[F"), (b"E1_SCROLLED", b"\x1b")]:
    ...
    print("PASS real private PTY: F2/End/Esc, 120x30 -> 60x18 resize, stable selection and termios restoration; no runtime")
finally:
