...
本轮材料补齐实际部署的 cute-codex light 源码、独立 Job Service 和 PRH/hostctl。请以指定 commit 为审核对象，不能仅查看两仓库的 main/release。最新追加了消息显示、Task 合同交接和 Job cwd / launcher 兼容修复，详见 [修复记录](MESSAGE-TASK-JOB-FIX.md)。旧发布记录保留在 Git 历史。
...
| cute-codex CLI、app-server、Code Mode host | [`1e916e0ecd259fdcc74f985c4a7f7309bf0f9989`](https://github.com/yang-jingsen/cute-codex/tree/1e916e0ecd259fdcc74f985c4a7f7309bf0f9989)；分支 `review/runtime-repair-20260914` | release-native-r2 CLI 已重建；app-server 和 Code Mode host 沿用 r1 未改动的文件，运行中的 owner 不被强制重启。 |
...
- cute-codex 实际 light 改造基线为 `3d2ee51ca2d5db578f328aa75e20aa22c0197c9a`，到 1e916e0ec 有 64 个提交。最近的恢复优化仅是 `8cde7956..a8677ec` 两个提交，不能把此前 light 改造遗漏掉。
...
# 在 cute-codex 仓库，light 改造及随后恢复修复
 git diff 3d2ee51ca2d5db578f328aa75e20aa22c0197c9a 1e916e0ecd259fdcc74f985c4a7f7309bf0f9989
# 若要核对上一轮看到的 release：比较两个完整树（不是三点 diff）
 git diff d52dc3d14bb36fa783a5e3c1942d7d13bd86d8c4 1e916e0ecd259fdcc74f985c4a7f7309bf0f9989
```
